...
# %%
def preprocessed(
    flair_dir="/mnt/e/MBashiri/Thesis/p4/MS_COHORT", 
    save_dir="/mnt/e/MBashiri/Thesis/p4/MS_COHORT_PREP",
    sample_file_name='101228.nii.gz', 
    imaging_o='not_FS', 
    imaging_w='T2W_F', 
    desired_dim=256
    ):
    ...
    files = [f for f in os.listdir(flair_dir) if (f.endswith('.nii.gz') and len(f) < (len(sample_file_name) + 2))]
    ...
    for file in files:
        ...
        # imaging_o = 'not_FS'    # flair_obj.ScanOptions
        # imaging_w = 'T2W_F' # flair_obj.ProtocolName
        ...
        skimage.io.imsave(out_path.replace('.nii.gz', '_10.png'), img)
        img = nifti_data_n[..., 4]
        img = np.uint8(255.0 * img)
        skimage.io.imsave(out_path.replace('.nii.gz', '_5.png'), img)

if __name__ == '__main__':

    preprocessed(
        flair_dir=r"E:/MBashiri/Thesis/p4/HC_COHORT/input",
        save_dir=r"E:/MBashiri/Thesis/p4/HC_COHORT_PREP",
        sample_file_name='110214_FLAIR.nii.gz',
        imaging_o='not_FS', 
        imaging_w='T2W_F', 
        desired_dim=256
        )
    ...
    preprocessed(
        flair_dir=r"E:/MBashiri/Thesis/p4/HC_COHORT/input_1",
        save_dir=r"E:/MBashiri/Thesis/p4/HC_COHORT_PREP",
        sample_file_name='110214_FLAIR.nii.gz',
        imaging_o='not_FS',
        imaging_w='T2W_F',
    ...
    preprocessed(
        flair_dir=r"E:/MBashiri/Thesis/p4/MS_COHORT",
        save_dir=r"E:/MBashiri/Thesis/p4/MS_COHORT_PREP",
        sample_file_name='101228.nii.gz',
        imaging_o='not_FS',
        imaging_w='T2W_F',
        desired_dim=256
